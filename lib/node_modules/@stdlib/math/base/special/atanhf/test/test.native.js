...
var negative = require( '@stdlib/math/base/special/atanhf/test/fixtures/julia/negative.json' );
var positive = require( '@stdlib/math/base/special/atanhf/test/fixtures/julia/positive.json' );
var smallNegative = require( '@stdlib/math/base/special/atanhf/test/fixtures/julia/small_negative.json' );
var smallPositive = require( '@stdlib/math/base/special/atanhf/test/fixtures/julia/small_positive.json' );
...
tape( 'the function returns `NaN` if provided a value less than `-1`', opts, function test( t ) {
	...
	for ( i = 0; i < 1e3; i++ ) {
		...
		t.strictEqual( isnan( atanhf( v ) ), true, 'returns NaN when provided '+v );
	}
	t.end();
});
